                ...
                >
                  ...
                  <div className="mb-8">
                    ...
                    <div className="flex items-baseline gap-1">
                      ...
                      <span className="text-xl font-bold text-zinc-500 uppercase">{pkg.speed.split(' ')[1] || 'Mbps'}</span>
                    </div>
                  </div>
            ...
            <div className="bg-zinc-950 px-8 py-6 rounded-xl flex flex-col sm:flex-row items-center gap-6">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-zinc-500 text-xs mt-0.5">100% Legal & Transparent Pricing</p>
                </div>
              </div>
