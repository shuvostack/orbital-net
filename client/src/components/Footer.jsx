        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex items-center gap-4">
              {settings?.facebook && (
                <a href={settings.facebook} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-orange-500 hover:border-orange-500 transition-all duration-300">
              ...
              {settings?.whatsapp && (
                <a href={`https://wa.me/${settings.whatsapp.replace(/[^0-9]/g, '')}`} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-rose-500 hover:border-rose-500 transition-all duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
              ...
              {settings?.youtube && (
                <a href={settings.youtube} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-blue-600 hover:border-blue-600 transition-all duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
              ...
              <a href="https://github.com/shuvostack" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-zinc-700 hover:border-zinc-700 transition-all duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
          ...
          <div className="lg:col-span-2 lg:col-start-6">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={index}>
                  <Link href={item.link} className="text-zinc-400 hover:text-orange-400 text-sm font-medium transition-colors flex items-center gap-2 group">
            ...
            <ul className="space-y-5">
              <li className="flex items-start gap-3">
                ...
                <span className="text-zinc-400 text-sm leading-relaxed whitespace-pre-line">
                  {settings?.address || 'আশেকপুর, টাঙ্গাইল সদর,\nটাঙ্গাইল, বাংলাদেশ।'}
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-orange-500 shrink-0" />
                <a href={`tel:${settings?.phone || '+8801717171081'}`} className="text-zinc-400 hover:text-white text-sm font-medium transition-colors">
                  {settings?.phone || '+880 1717171081'}
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-orange-500 shrink-0" />
                <a href={`mailto:${settings?.email || 'info.orbitalnet@gmail.com'}`} className="text-zinc-400 hover:text-white text-sm font-medium transition-colors">
        ...
        <div className="pt-6 mt-4 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="bg-zinc-900/50 w-full py-4 px-6 rounded-xl border border-zinc-800 flex flex-col md:flex-row items-center justify-between">
            ...
            <p className="text-zinc-500 text-xs font-medium mt-2 md:mt-0 flex items-center gap-1">
              Developed by
              <a href="https://github.com/shuvostack" target="_blank" rel="noreferrer" className="text-zinc-300 hover:text-orange-500 font-bold transition-colors ml-1">
                Mehedi Hasan Shuvo
              </a>
            </p>
          </div>
