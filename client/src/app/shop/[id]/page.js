...
import { ShoppingCart, ArrowLeft, ShieldCheck, Truck, RotateCcw, AlertCircle, Plus, Minus } from 'lucide-react';
  ...
  if (error || !product) {
    return (
      <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-4 text-center">
        ...
        <Link href="/shop" className="px-6 py-3 bg-zinc-900 border border-zinc-800 text-white rounded-xl hover:bg-zinc-800 transition-colors">
          শপে ফিরে যান
        </Link>
      </div>
    );
          ...
          >
            ...
            <div className="bg-zinc-900/60 border border-zinc-800 rounded-3xl p-6 mb-8 backdrop-blur-sm">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                ...
                <div className="flex items-center gap-4">
                  <span className="text-zinc-400 font-medium text-sm">পরিমাণ:</span>
                ...
                {/* Status */}
                <div>
                  <span className="text-zinc-400 font-medium text-sm block mb-1">স্ট্যাটাস:</span>
                  <span className={`font-bold ${product.countInStock > 0 ? 'text-emerald-400' : 'text-rose-500'}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="flex items-center gap-3 text-zinc-400 bg-zinc-900/40 p-4 rounded-2xl border border-zinc-800/50">
                ...
                <span className="text-sm font-medium leading-tight">100%<br/>অরিজিনাল</span>
              </div>
              <div className="flex items-center gap-3 text-zinc-400 bg-zinc-900/40 p-4 rounded-2xl border border-zinc-800/50">
                <Truck className="w-6 h-6 text-blue-400" />
                <span className="text-sm font-medium leading-tight">দ্রুত<br/>ডেলিভারি</span>
              </div>
              <div className="flex items-center gap-3 text-zinc-400 bg-zinc-900/40 p-4 rounded-2xl border border-zinc-800/50">
                <RotateCcw className="w-6 h-6 text-purple-400" />
                <span className="text-sm font-medium leading-tight">রিটার্ন<br/>পলিসি</span>
              </div>
            </div>
