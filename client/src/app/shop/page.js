  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        setError(
          "প্রোডাক্ট লোড করতে সমস্যা হয়েছে। কিছুক্ষণ পর আবার চেষ্টা করুন।",
        );
        setLoading(false);
      }
    };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-lg text-zinc-400 font-medium max-w-2xl mx-auto leading-relaxed">
              রাউটার থেকে শুরু করে অত্যাধুনিক সিসি ক্যামেরা এবং সোলার সিস্টেম—
              আপনার প্রয়োজনীয় সবকিছু পাচ্ছেন অরবিটাল স্টোরে।
            </p>
          </motion.div>
        </div>
      </section>
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 bg-zinc-900/40 border border-zinc-800 rounded-3xl">
              ...
              <p className="text-zinc-500 text-sm">
                অন্য কোনো ক্যাটাগরি বা নাম লিখে সার্চ করুন।
              </p>
            </div>
          ) : (
            <>
                  ...
                  {currentProducts.map((product) => (
                    ...
                    >
                      ...
                      <Link
                        ...
                        className="w-full h-48 bg-white rounded-2xl mb-5 flex items-center justify-center relative overflow-hidden group-hover:border-orange-500/30 transition-colors p-4 block"
                      >
                        <motion.img
                          ...
                          src={
                            product.imageUrl ||
                            "https://i.ibb.co/sK08zKj/no-image-placeholder.png"
                          }
                          alt={product.name}
