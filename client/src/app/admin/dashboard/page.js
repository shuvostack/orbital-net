    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const [ordersRes, productsRes, packagesRes] = await Promise.all([
          ...
          axios.get("https://orbital-backend-9y6q.onrender.com/api/products"),
          axios.get("https://orbital-backend-9y6q.onrender.com/api/packages"),
        ]);
        ...
        <div className="xl:col-span-2 space-y-6">
          ...
          >
            ...
            <div className="h-48 flex items-end justify-between gap-2 mb-8 px-2">
              {chartData.map((height, i) => (
                <div
                  key={i}
                  className="w-full bg-zinc-800/50 rounded-t-sm relative group flex items-end justify-center h-full"
                >
                  <div
                    style={{ height: `${height}%` }}
            ...
            <div className="grid grid-cols-2 gap-4 border-t border-zinc-800/50 pt-6">
              ...
              <div className="mt-4">
                ...
                <p className="text-orange-400 font-medium">
                  {stats.pendingOrders} Needs Attention
                </p>
              </div>
          ...
          >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-4 flex flex-col justify-center transition-colors hover:border-orange-500/50">
                ...
                <p className="text-center text-zinc-400 text-xs font-bold uppercase mb-1">
                  Shop Products
                </p>
          ...
          {stats.pendingOrders > 0 && (
            <motion.div
              ...
              className="bg-orange-500/5 border border-dashed border-orange-500/30 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4"
            >
              <div className="flex items-center gap-4 text-orange-200">
                ...
                <p className="text-sm">
                  ...
                  that need to be processed. Please check the order management
                  section.
                </p>
              </div>
              <Link
                href="/admin/orders"
                className="shrink-0 bg-gradient-to-r from-orange-500 to-rose-500 text-white px-6 py-2.5 rounded-xl font-bold text-sm uppercase tracking-wider hover:scale-105 transition-transform shadow-lg shadow-orange-500/20"
              >
                Manage Orders
              </Link>
            </motion.div>
        ...
        <div className="xl:col-span-1 space-y-6">
          ...
          >
            <div>
              ...
              <Link
                href="/admin/orders"
                className="text-orange-500 text-xs font-bold uppercase tracking-wider hover:text-orange-400"
              >
                VIEW ORDERS
              </Link>
            </div>
            {/* Circle UI */}
            <div
              className={`w-20 h-20 rounded-full border-4 flex items-center justify-center transition-colors ${stats.pendingOrders > 0 ? "border-zinc-800 border-t-orange-500 border-r-orange-500" : "border-zinc-800 border-t-emerald-500 border-r-emerald-500"}`}
            >
          ...
          >
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-4">
              This admin dashboard allows you to fully manage your ISP website
