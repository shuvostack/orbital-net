...
export default function AdminSettingsPage() {
  ...
  const handlePasswordSave = async (e) => {
    ...
    if (passData.newPassword !== passData.confirmPassword) {
      return Swal.fire({
        icon: "error",
        title: "পাসওয়ার্ড মিলেনি!",
        text: "নতুন এবং কনফার্ম পাসওয়ার্ড একই হতে হবে।",
        background: "#18181b",
        color: "#fff",
      });
    }
    if (passData.newPassword.length < 6) {
      return Swal.fire({
        icon: "warning",
        title: "পাসওয়ার্ড ছোট!",
        text: "পাসওয়ার্ড কমপক্ষে ৬ অক্ষরের হতে হবে।",
        background: "#18181b",
        color: "#fff",
      });
    }
    ...
    try {
      const config = { headers: { Authorization: `Bearer ${token}` } };
      await axios.put(
        "https://orbital-backend-9y6q.onrender.com/api/settings/password",
        { password: passData.newPassword },
        config,
      );
      Swal.fire({
        icon: "success",
        title: "পাসওয়ার্ড চেঞ্জ হয়েছে!",
        text: "পরবর্তী লগইনে নতুন পাসওয়ার্ড ব্যবহার করুন।",
        background: "#18181b",
        color: "#fff",
      ...
      <div className="bg-zinc-900/50 p-6 rounded-3xl border border-zinc-800 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-zinc-500 text-sm">
            ওয়েবসাইটের ডাটা এবং সিকিউরিটি ম্যানেজ করুন
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <form
            ...
            className="bg-zinc-900/40 p-6 md:p-8 rounded-3xl border border-zinc-800 space-y-6"
          >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-950 border border-zinc-800 text-white rounded-xl pl-11 pr-4 py-3 focus:border-orange-500 outline-none transition-colors"
                  />
                </div>
              </div>
              <div>
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    onChange={handleSettingsChange}
                    className="w-full bg-zinc-950 border border-zinc-800 text-white rounded-xl pl-11 pr-4 py-3 focus:border-orange-500 outline-none transition-colors custom-scrollbar"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="pt-6 flex justify-end border-t border-zinc-800">
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 rounded-xl font-bold bg-orange-500 text-white hover:bg-orange-600 transition-colors disabled:opacity-50"
              >
                {savingSettings ? (
        ...
        <div className="space-y-8">
          ...
          <div className="bg-zinc-900/40 p-6 md:p-8 rounded-3xl border border-rose-500/20 space-y-6">
            <h2 className="text-lg font-bold text-white flex items-center gap-2 mb-6 border-b border-zinc-800 pb-4">
              <ShieldAlert className="w-5 h-5 text-rose-500" /> Emergency
              Switches
            </h2>
            ...
            <div className="flex items-center justify-between p-4 bg-zinc-950 border border-zinc-800 rounded-xl">
              <div>
                ...
                <p className="text-zinc-500 text-xs mt-0.5">
                  অফ করে রাখুন ওয়েবসাইট আপডেট করার সময়
                </p>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-zinc-950 border border-zinc-800 rounded-xl">
              <div>
                ...
                <p className="text-zinc-500 text-xs mt-0.5">
                  ওয়েবসাইট থেকে অর্ডার নেওয়া বন্ধ/চালু
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
            ...
            <button
              ...
              disabled={savingSettings}
              className="w-full py-3 rounded-xl font-bold bg-zinc-800 text-white hover:bg-zinc-700 transition-colors"
            >
              Update Switches
            </button>
          </div>
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-zinc-950 border border-zinc-800 text-white rounded-xl px-4 py-3 focus:border-purple-500 outline-none transition-colors"
                placeholder="••••••••"
                required
              />
            </div>
            ...
            <button
              ...
              className="w-full flex justify-center items-center gap-2 py-3 rounded-xl font-bold bg-purple-500 text-white hover:bg-purple-600 transition-colors disabled:opacity-50"
            >
              {savingPassword ? (
                <Loader2 className="w-5 h-5 animate-spin" />
              ) : (
