        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-lg text-zinc-400 max-w-2xl mx-auto font-medium leading-relaxed">
              আপনার বাসা কিংবা অফিসের জন্য বেছে নিন সবচেয়ে মানানসই প্যাকেজ। কোনো লুকায়িত চার্জ নেই, যখন ইচ্ছে আপগ্রেড করুন।
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {currentPackages.map((pkg, index) => (
                <div 
                  key={index}
                  className={`relative bg-zinc-900/40 rounded-[2.5rem] p-8 md:p-10 transition-all duration-300 hover:-translate-y-2 group
                    ${pkg.isPopular 
                      ? 'border-2 border-orange-500 shadow-[0_0_40px_rgba(249,115,22,0.15)] z-10 scale-[1.02]' 
                ...
                >
                  ...
                  <Link 
                    ...
                    className={`w-full flex items-center justify-center gap-2 py-4 rounded-xl font-black text-sm uppercase tracking-wider transition-all
                      ${pkg.isPopular 
                        ? 'bg-gradient-to-r from-orange-500 to-rose-500 text-white shadow-lg hover:shadow-orange-500/25 hover:scale-[1.02]' 
