...
export default function GetConnectionPage() {
  ...
  return (
    <div className="bg-zinc-950 min-h-screen pb-24 relative overflow-hidden">
      ...
      {/* Header Section */}
      <section className="pt-30 pb-12 relative z-10 text-center px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <h1 className="text-4xl md:text-5xl font-black text-white leading-tight mb-4 tracking-tight">
            নতুন <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-rose-500">কানেকশন</span> রিকোয়েস্ট
          </h1>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Area */}
              <div className="space-y-1.5">
                <label className="text-zinc-400 text-xs font-bold uppercase tracking-wider ml-1">এলাকা (যেমন: সাবালিয়া) <span className="text-rose-500">*</span></label>
                <div className="relative">
            ...
            <p className="text-center text-zinc-500 text-xs mt-3">
              সাবমিট করলে এটি সরাসরি আমাদের হোয়াটসঅ্যাপে চলে যাবে।
            </p>
